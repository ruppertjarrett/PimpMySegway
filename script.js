...
function add_nav() {
    ...
    var preset_1_placeholder = document.createTextNode("The Roadster");
    ...
    var preset_2_placeholder = document.createTextNode("The Huntsman");
    ...
    var preset_4_placeholder = document.createTextNode("The Hipster");
...
function add_footer() {
    ...
    checkout.setAttribute('class', 'btn');
    rightFooter.appendChild(checkout);
    var checkout_placeholder = document.createTextNode("Checkout");
...
function checkout(evt) {
    ...
    image.style.backgroundRepeat = "no-repeat";
    image.style.backgroundSize = "cover";
    document.getElementById('item_list').innerHTML = "Item List: ";
    totalCost = 600
    document.getElementById('price').innerHTML = "Total: $" + totalCost;
}
